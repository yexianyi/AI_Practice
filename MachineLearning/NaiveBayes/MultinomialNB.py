...
# 加载数据集  
# 我们只使用'alt.atheism'和'soc.religion.christian'两个类别来简化示例  
...
# 可以选择查看一些具体的预测结果  
# 注意：newsgroups.target_names给出了类别的真实名称  
predicted_labels = [newsgroups.target_names[label] for label in y_pred]  
true_labels = [newsgroups.target_names[label] for label in y_test]  
